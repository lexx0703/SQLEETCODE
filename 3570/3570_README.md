...
### Explanation
* **The Great Gatsby (book_id = 1):** Total copies = 3, Active borrowers = 3. Available copies: `3 - 3 = 0` (Included).
* **1984 (book_id = 3):** Total copies = 1, Active borrowers = 1. Available copies: `1 - 1 = 0` (Included).
* **To Kill a Mockingbird (book_id = 2):** Total copies = 3, Active borrowers = 2. Available copies = 1 (Excluded).
* **Brave New World (book_id = 6):** Total copies = 4, Active borrowers = 1. Available copies = 3 (Excluded).
